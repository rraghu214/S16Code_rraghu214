...
CAPTURE_CONTENT_ENV = "S16_OTEL_CAPTURE_CONTENT"
ENDPOINT_ENV = "S16_OTEL_EXPORTER_ENDPOINT"
SERVICE_NAME_ENV = "S16_OTEL_SERVICE_NAME"
DEFAULT_SERVICE_NAME = "s16code"
...
def emit_span_tree(
    ...
    *,
    ...
    instrumentation_name: str = "s16code.telemetry",
) -> None:
