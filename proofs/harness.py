...
from s16code.core.memory.embeddings import DeterministicEmbedder  # noqa: E402
from s16code.economics import EconomicsConfig, MeteredTransport  # noqa: E402
...
def parse(description: str, argv: list[str] | None = None) -> Args:
    ...
    parser.add_argument("--otel-endpoint", default=os.getenv("S16_OTEL_EXPORTER_ENDPOINT"),
