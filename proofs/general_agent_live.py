"""Run replaceable agentic tasks through the real S16 HTTP path and score them.
...
def main() -> None:
    ...
    parser.add_argument("--judge-provider", default=os.getenv("S16_PROOF_JUDGE_PROVIDER", "gemini"))
    ...
    with httpx.Client(timeout=900) as client:
        for ordinal, original in enumerate(tasks, 1):
            ...
            scope = {"tenant_id": "s16-stress", "project_id": task["id"], "user_id": "reviewer"}
            preludes = []
            prelude_attempts = []
