...
from s16code.ui.catalog import COMPONENTS, REGISTERED_ACTIONS, catalog_manifest
from s16code.ui.fixtures import RecordedJournal
from s16code.ui.hitl import PendingAction, decide_resume
from s16code.ui.routes import router as ui_router
from s16code.ui.surface import build_run_surface
from s16code.ui.validator import Invariant, validate_surface
...
def client() -> TestClient:
    app = FastAPI()
    app.include_router(ui_router)  # exactly how s16code.main folds the UI in
...
def test_render_client_never_uses_innerhtml_and_documents_the_contract():
    html = (_BUILD_ROOT / "s16code" / "ui" / "client" / "index.html").read_text()
